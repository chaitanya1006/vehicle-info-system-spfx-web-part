...
function VehicleComponent(props) {
    ...
    //Fetching data from the SharePoint 'Vehicles' list and display on the web part
    var fetchData = function (apiUrl) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var response, data, items, _a, _b, _c, _d, _e;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    data = _f.sent();
                    items = data.value;
                    /* eslint-disable */ console.log.apply(//sharepoint returns the array in the 'value' property
                    console, oo_oo("2349704275_69_6_69_24_4", items));
                    return [2 /*return*/, items];
                case 3:
                    _b = 
                    /* eslint-disable */ (_a = console.error).apply;
                    _c = [
                        /* eslint-disable */ console];
                    _d = oo_tx;
                    _e = ["2349704275_72_6_72_67_11", "Error fetching items:"];
                    return [4 /*yield*/, response.text()];
                case 4:
                    /* eslint-disable */ _b.apply(_a, _c.concat([_d.apply(void 0, _e.concat([_f.sent()]))]));
                    _f.label = 5;
    ...
    var handleSubmit = function (event) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            try {
                /* eslint-disable */ console.log.apply(console, oo_oo("2349704275_100_6_100_56_4", "formRef.current: ".concat(formRef.current)));
                if (!formRef.current)
                    return [2 /*return*/];
                formData_1 = new FormData(formRef.current);
                formValues = Object.fromEntries(formData_1.entries());
                /* eslint-disable */ console.log.apply(console, oo_oo("2349704275_106_6_106_66_4", "Form submitted: ".concat(JSON.stringify(formValues))));
                ...
                /* eslint-disable */ console.error.apply(console, oo_tx("2349704275_128_6_128_65_11", "Error while adding new vehicle information"));
            }
            return [2 /*return*/];
        });
    }); };
    var performAdd = function (url, body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, props.context.spHttpClient.post(url, sp_http_1.SPHttpClient.configurations.v1, {
                        headers: {
                ...
                case 3:
                    error = _a.sent();
                    /* eslint-disable */ console.error.apply(console, oo_tx("2349704275_152_6_152_26_11", error));
    ...
    var performUpdate = function (id, url, body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error = _a.sent();
                    /* eslint-disable */ console.error.apply(console, oo_tx("2349704275_180_6_180_26_11", error));
                    alert("Error: " + error.error.message.value);
                    _a.label = 4;
                case 4: return [2 /*return*/];
            }
    ...
    var handleDelete = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var endpoint, headers, response, error, error_1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    response = _a.sent();
                    if (!response.ok) return [3 /*break*/, 3];
                    /* eslint-disable */ console.log.apply(console, oo_oo("2349704275_206_8_206_55_4", "Item ".concat(id, " deleted successfully.")));
                    loadVehicleListForDataGrid();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, response.json()];
                case 4:
                    error = _a.sent();
                    /* eslint-disable */ console.error.apply(console, oo_tx("2349704275_210_8_210_52_11", "Error deleting item:", error));
                    _a.label = 5;
                case 5: return [3 /*break*/, 7];
                case 6:
                    error_1 = _a.sent();
                    /* eslint-disable */ console.error.apply(console, oo_tx("2349704275_213_6_213_45_11", "Request failed:", error_1));
                    return [3 /*break*/, 7];
    ...
    var handleEdit = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var apiUrl, response, item, error_2;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
